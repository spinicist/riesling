...
{
  if (W == 3) {
    return std::make_unique<Grid<Scalar, Radial<ND, KaiserBessel<3>>>>(traj, osamp, nC, basis);
  } else if (W == 4) {
    return std::make_unique<Grid<Scalar, Radial<ND, KaiserBessel<4>>>>(traj, osamp, nC, basis);
  } else if (W == 5) {
    return std::make_unique<Grid<Scalar, Radial<ND, KaiserBessel<5>>>>(traj, osamp, nC, basis);
  } else if (W == 7) {
    return std::make_unique<Grid<Scalar, Radial<ND, KaiserBessel<7>>>>(traj, osamp, nC, basis);
  }
