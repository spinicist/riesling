 ...
 * (without SENSE maps)
 */
auto KSpaceSingle(Trajectory const &traj, Re2 const &basis, float const bias, bool const ndft) -> Re2
{
...
auto make_kspace_pre(
  std::string const &type, Index const nC, Trajectory const &traj, Re2 const &basis, float const bias, bool const ndft)
