...
template void Forward<2, 2>(Cx2Map, Sz2 const);
...
template void Forward<2, 2>(Cx2 &, Sz2 const);
template void Forward<3, 1>(Cx3 &, Sz1 const);
template void Forward<3, 2>(Cx3 &, Sz2 const);
template void Forward<3, 3>(Cx3 &, Sz3 const);
...
template void Adjoint<2, 2>(Cx2Map, Sz2 const);
...
template void Adjoint<2, 2>(Cx2 &, Sz2 const);
template void Adjoint<3, 1>(Cx3 &, Sz1 const);
template void Adjoint<3, 2>(Cx3 &, Sz2 const);
template void Adjoint<3, 3>(Cx3 &, Sz3 const);
