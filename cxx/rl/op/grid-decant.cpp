...
template <int ND, typename KF, int SG> void GridDecant<ND, KF, SG>::iforward(InCMap x, OutMap y) const
{
...
template <int ND, typename KF, int SG> void GridDecant<ND, KF, SG>::iadjoint(OutCMap y, InMap x) const
{
