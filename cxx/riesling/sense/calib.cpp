...
void main_sense_calib(args::Subparser &parser)
{
  ...
  //   channels, ref, senseOpts.kWidth.Get(), gridOpts.osamp.Get(), senseOpts.l.Get(), senseOpts.λ.Get());
  Cx5 const   maps = SENSE::EstimateMaps(channels, ref, senseOpts.l.Get(), senseOpts.λ.Get());
