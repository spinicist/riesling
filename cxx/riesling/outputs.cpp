...
template void
WriteOutput<5>(std::string const &, std::string const &, Cx5 const &, HD5::DNames<5> const &, Info const &);
template void
WriteOutput<6>(std::string const &, std::string const &, Cx6 const &, HD5::DNames<6> const &, Info const &);
