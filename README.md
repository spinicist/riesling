...
For further examples we have a separate repository [riesling-examples](https://github.com/spinicist/riesling-examples) which is continuously updated with new examples.
