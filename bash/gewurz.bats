@test "Cart" {
    ...
    VOX=4
    PREFIX="c"
    riesling phantom ${PREFIX}-phantom.h5 --matrix=$MAT --vox-size=$VOX --size=96 --cart
    ...
    riesling op-nufft ${PREFIX}-ks-nufft.h5 ${PREFIX}-img-nufft.h5
    # gewurz dft ${PREFIX}-ks-nufft.h5 ${PREFIX}-img-dft.h5 -v2
...
@test "Radial" {
    ...
    VOX=4
    PREFIX="r"
    riesling phantom ${PREFIX}-phantom.h5 --matrix=$MAT --vox-size=$VOX --size=96
    riesling sense-sim ${PREFIX}-sim-sense.h5 --matrix=$MAT --vox-size=$VOX --channels=1
    riesling op-sense --fwd ${PREFIX}-phantom.h5 ${PREFIX}-channels.h5 ${PREFIX}-sim-sense.h5
    riesling op-nufft --fwd ${PREFIX}-channels.h5 ${PREFIX}-ks-nufft.h5
    riesling op-nufft ${PREFIX}-ks-nufft.h5 ${PREFIX}-img-nufft.h5
